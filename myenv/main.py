...
def forecast_stock_prices(data, days=30):
    ...
    future = model.make_future_dataframe(df, periods=days)
...
if st.sidebar.button('Update'):
    ...
    forecast_data = forecast_stock_prices(data, days=forecast_days)
...
#streamlit run E:\Project\myenv\main.py